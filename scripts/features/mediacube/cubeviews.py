...
def cube_degrees_0(textures):
    ...
    glFrontFace(GL_CCW)
    glBindTexture(GL_TEXTURE_2D, texture_ids[TEXTURE_VIDEOFRAME])
    glBegin(GL_POLYGON)
    ...
    glEnd()
    glBindTexture(GL_TEXTURE_2D, texture_ids[TEXTURE_GREEN])
    glBegin(GL_POLYGON)
    glTexCoord2fv([0.0, 0.0])
    glVertex3fv([1.1, 1.1, -1.1])
    glTexCoord2fv([1.0, 0.0])
    ...
    glEnd()
    glBindTexture(GL_TEXTURE_2D, texture_ids[TEXTURE_YELLOW])
    glBegin(GL_POLYGON)
    glTexCoord2fv([0.0, 0.0])
    glVertex3fv([1.1, -0.0, -0.0])
    glTexCoord2fv([1.0, 0.0])
    ...
    glVertex3fv([1.1, 0.0, -1.1])
    glEnd()
    glBindTexture(GL_TEXTURE_2D, texture_ids[TEXTURE_BLUE])
    glBegin(GL_POLYGON)
    glTexCoord2fv([0.0, 0.0])
    glVertex3fv([0.0, 1.1, -1.1])
    glTexCoord2fv([1.0, 0.0])
    ...
    glVertex3fv([0.0, 1.1, 0.0])
    glEnd()
    glBindTexture(GL_TEXTURE_2D, texture_ids[TEXTURE_PINK])
    glBegin(GL_POLYGON)
    glTexCoord2fv([0.0, 0.0])
    glVertex3fv([0.0, 1.1, -1.1])
    glTexCoord2fv([1.0, 0.0])
